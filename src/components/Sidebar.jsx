...
const Sidebar = () => {
  ...
  return (
    <header className='  lg:h-screen'>
      <div className="flex flex-col lg:w-[17%] xl:max-w-[17rem] lg:bg-black text-greytext  lg:h-full justify-between lg:pt-8        
        ...
        {/* mobile hamburger */}
        <div className=' lg:hidden  h-14 mt-4   w-screen px-6 sm:px-6 flex flex-row   justify-between  items-center z-10 '>
        ...
        {/* mobile menu */}
        <div className={nav ? ' leading-loose text-start bg-black pl-3  text-base pt-8  space-y-4   text-greytext left-0 top-0   w-[60%]  mx-auto z-10   duration-300 flex h-full fixed  flex-col' : 'absolute left-[-100%] '}>
          <div className='flex flex-row justify-between  items-center'>
            <div className='flex mb-6  space-x-2  items-center'>
              <img src='./images/logo.png' alt='logo' className='w-6' />
              <h1 className=' text-base font-bold font-mono mt-2 bg-gradient-to-r from-blue  to-yellow uppercase bg-clip-text text-transparent'> Marketie </h1>
            </div>

            <IoMdClose className='font-bold -mt-6 mr-3 hover:cursor-pointer text-2xl text-white' onClick={handleNav} />
          </div>
